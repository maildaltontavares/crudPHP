<?php
 ...
 //var_dump($acesso->validaAcesso('00001'));
  ...
  if (isset($_POST['excluir'])): 
      ...
      if ($tabelaCtr->delete($_POST['Idx'])== 'OK'):  
         $excluiu = 'S';
              ...
              if (empty($erros)):  // Nao tem erros de digitacao
                  ...
                  if ($Altera == "N"):
                      ...
                      if ($tabelaCtr->update($id,$id_tp,$str1,$str2,$str3,$flag1, $flag2,$flag3, $num1,$num2 ,$num3,$data1, $data2,$data3 )== 'OK'):  
                          ...
                          echo '<div class="alert alert-primary" role="alert"><li>' . "Erro ao alterar!!!"  . '</li></div>';$gravou = "N";                  
                      endif;  
    ...
    <div id='modelo'>
        <div class="cabecalho">
            ...
            <?php
                     ...
                     $acesso->configura_botoes($validaAcesso,'tabelaCad','lista_tabela',$excluiu,$Altera,$id,$gravou);          
                ?>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-8"> 
          ...
          <?php
              ...
              foreach($tabpad->lerTodasGeral() as $p_tabpad):
