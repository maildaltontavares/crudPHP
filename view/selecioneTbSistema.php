<?php
  ...
  // Valida os acessos
  $acesso = new Funcao();
  $validaAcesso = $acesso->validaAcesso('00011');
 //var_dump($acesso->validaAcesso('00001'));
  if (strlen($validaAcesso)==0): 
     header('Location:semAcesso.php?tela="Tabelas de configuração"'); 
     //exit; 
  endif;
...
<form method="POST" > 
  <div class = 'container'> 
      ...
      <div id='modelo'>
          <div class="cabecalho">
              <h1 class="p-3 mb-2  text-dark cTitulo">Seleção de tabelas de configuração</h1>
              <div id="grupoBotoes">                   
      ...
      <div class="form-row">
          ...
          <?php
              ...
              foreach($tabpad->lerTodasSistema() as $p_tabpad): 
